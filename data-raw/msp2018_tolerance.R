...
ac_lifeseq = read_tsv('data-raw/msp2018_tolerance/Lifeseq_non-redundant_augmented-catalog.fasta.clstr')

msp2018 = read_tsv("data-raw/msp2018_tolerance/IGC.1661MSP.tsv")
...
genes_metadata = read_tsv('data-raw/msp2018_tolerance/Lifeseq_non-redundant_augmented-catalog_lite.genes_length.tsv')
