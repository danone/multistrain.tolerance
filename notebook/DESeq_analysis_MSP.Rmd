...
## test percent = 1 (292MSP), le rhamno ne ressort plus
## test percent = 0.1, prevalence = 5%
```
...
dds = DESeq2::DESeqDataSetFromMatrix(
  ...
  colData = Tolerance::sample_metadata_metaG_v2v4 %>% tibble::column_to_rownames("samplenr"), 
  design = ~ Visit + Subject)
