...
sample_metadata_dose3v4$Visit = as.factor(sample_metadata_dose3v4$Visit)
sample_metadata_dose3v4$Groupe = as.factor(sample_metadata_dose3v4$Groupe)
sample_metadata_dose3v4$Groupe_dose = as.factor(sample_metadata_dose3v4$Groupe_dose)
...
Tolerance::sample_metadata_dose3v4 %>% head
...
data.frame() %>% tibble::rownames_to_column("genus")
 save(res_ATN3_CP3_v4only, file="res_ATN3_CP3_v4only.rda")
