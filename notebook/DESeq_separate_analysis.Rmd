...
sample_metadata_ATN = sample_metadata[sample_metadata$Groupe=="ATN",]
sample_metadata_dose1$Groupe = relevel(sample_metadata_dose1$Groupe, ref = "CP") 
sample_metadata_dose1$Groupe_dose = relevel(sample_metadata_dose1$Groupe_dose, ref = "CP.1") 
sample_metadata_dose1 %>% head
save(sample_metadata_dose1, file="../data/sample_metadata_dose1.rda")
...
load("genus_dose3.rda")

rownames(genus)=genus$genus
genus_tmp = genus[,-1]
genus_dose1 = genus_tmp[match(sample_metadata_dose1$samplenr, colnames(genus_tmp))]
genus_dose1$genus= rownames(genus_dose1)
genus= genus_dose1
save(genus, file="genus_dose1.rda")
...
save(dds_res1, file="deseq2_dds_res1_separate_analysis_dose3.rda")
...
save(dds2_res1, file="deseq2_dds2_res1_separate_analysis_dose3.rda")
...
save(dds2_res2, file="deseq2_dds2_res2_separate_analysis_dose3.rda")
load("deseq2_dds2_res2_separate_analysis_dose3.rda")
...
res_ATN3_CP3_v2v4_genus_separate_all=
results(dds2_res2, contrast = list("Groupe_doseATN.3.VisitV4","Groupe_doseCP.3.VisitV4"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")
save(res_ATN3_CP3_v2v4_genus_separate_all, file="res_ATN3_CP3_v2v4_genus_separate_all.rda")
write.csv2(res_ATN3_CP3_v2v4_genus_separate_all, file="res_ATN3_CP3_v2v4_genus_separate_all.csv")
...
dds = DESeq2::DESeqDataSetFromMatrix(
  countData = t(genus_count[Tolerance::sample_metadata_dose3$samplenr,]) +1, 
  colData = Tolerance::sample_metadata_dose3 %>%
  tibble::as_tibble() %>%
  as.data.frame() %>%
...
dds_res1_genus_all_no_appariement = results(dds_res1) %>% as.data.frame() %>%
      tibble::rownames_to_column("genus")
save(dds_res1_genus_all_no_appariement, file="dds_res1_genus_all_no_appariement.rda")
write.csv2(dds_res1_genus_all_no_appariement, file="dds_res1_genus_all_no_appariement.csv")
...
tiff(file="DESeq2_ATN3_CP3_separate_analysis_noDO.tiff", w=1500, h=500) 
rbind(
    data.frame(res_ATN3_CP3_v2v3,visit="D14"),
    data.frame(res_ATN3_CP3_v2v4,visit="D28"), 
    data.frame(res_ATN3_CP3_v2v5,visit="D56")
...
sample_metadata_dose3_v2v4$Groupe_dose = relevel(sample_metadata_dose3_v2v4$Groupe_dose, ref = "CP.3") 
...
dds = DESeq2::DESeqDataSetFromMatrix(
  countData = t(genus_count[Tolerance::sample_metadata_dose3_v2v4$samplenr,]) +1, 
  colData = Tolerance::sample_metadata_dose3_v2v4 %>%
  tibble::as_tibble() %>%
  as.data.frame() %>%
  tibble::column_to_rownames("samplenr"), 
  design = ~ Visit + Groupe_dose + Visit:Groupe_dose)
...
dds_res1_genus_all_dose3_v2v4_no_appariement = results(dds_res1) %>% as.data.frame() %>%
      tibble::rownames_to_column("genus")
save(dds_res1_genus_all_dose3_v2v4_no_appariement, file="dds_res1_genus_all_dose3_v2v4_no_appariement.rda")
write.csv2(dds_res1_genus_all_dose3_v2v4_no_appariement, file="dds_res1_genus_all_dose3_v2v4_no_appariement.csv")
...
load("deseq2_dds2_res2_separate_analysis_v2v4.rda")
```
...
res_ATN3_CP3_v2v4_genus_all_v2v4only=
results(dds2_res2, contrast = list("Groupe_doseATN.3.VisitV4","Groupe_doseCP.3.VisitV4"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")
save(res_ATN3_CP3_v2v4_genus_all_v2v4only, file="res_ATN3_CP3_v2v4_genus_all_v2v4only.rda")
write.csv2(res_ATN3_CP3_v2v4_genus_all_v2v4only, file="res_ATN3_CP3_v2v4_genus_all_v2v4only.csv")
...
# ------- DESeq2 for genus dose 1x (ATN1 vs CP1)------
...
Tolerance::sample_metadata_dose1 %>%
  tibble::column_to_rownames("samplenr") %>% head
...
dds = DESeq2::DESeqDataSetFromMatrix(
  countData = t(genus_count[Tolerance::sample_metadata_dose1$samplenr,]), 
  colData = Tolerance::sample_metadata_dose1 %>% tibble::column_to_rownames("samplenr"), 
  design = ~ Visit + Subject)
...
save(dds_res1, file="deseq2_dds_res1_separate_analysis_dose1.rda")
...
temp <- Tolerance::sample_metadata_dose1 #%>% tibble::column_to_rownames("samplenr")
temp <- temp[with(temp, order(Groupe_dose, Subject)), ]
new_sub <- data.frame(Reduce(rbind, 
                            by(as.data.frame(temp), 
                                temp$Groupe_dose, 
...
dds2_res1 <- nbinomLRT(dds2, full = mod, reduced = mod2)
# using supplied model matrix
# 35 rows did not converge in beta, labelled in mcols(object)$fullBetaConv. Use larger maxit argument with nbinomLRT


save(dds2_res1, file="deseq2_dds2_res1_separate_analysis_dose1.rda")
...
save(dds2_res2, file="deseq2_dds2_res2_separate_analysis_dose1.rda" )
load("deseq2_dds2_res2_separate_analysis.rda")
...
results(dds2_res2, contrast = list("Groupe_doseATN.1"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
save(res_ATN1_CP1_v2, file="res_ATN1_CP1_v2_p0.05_separate.rda")

res_ATN1_CP1_v2v3=
results(dds2_res2, contrast = list("Groupe_doseATN.1.VisitV3","Groupe_doseCP.1.VisitV3"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
save(res_ATN1_CP1_v2v3, file="res_ATN1_CP1_v2v3_p0.05_separate.rda")

res_ATN1_CP1_v2v4=
results(dds2_res2, contrast = list("Groupe_doseATN.1.VisitV4","Groupe_doseCP.1.VisitV4"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
save(res_ATN1_CP1_v2v4, file="res_ATN1_CP1_v2v4_p0.05_separate.rda")

res_ATN1_CP1_v2v5=
results(dds2_res2, contrast = list("Groupe_doseATN.1.VisitV5","Groupe_doseCP.1.VisitV5"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
save(res_ATN1_CP1_v2v5, file="res_ATN1_CP1_v2v5_p0.05_separate.rda")

tiff(file="DESeq2_ATN1_CP1_separate_analysis_noD0.tiff", w=1500, h=500) 
rbind(
...
# ------- DESeq2 for dose effect ATN3 vs ATN1
