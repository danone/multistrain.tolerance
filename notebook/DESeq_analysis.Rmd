...
dds = DESeq2::DESeqDataSetFromMatrix(
  countData = t(genus_count[Tolerance::sample_metadata$samplenr,]) +1, 
  colData = Tolerance::sample_metadata %>%
  tibble::as_tibble() %>%
  as.data.frame() %>%
...
dds_res1_genus_all_alldose_no_appariement = results(dds_res1) %>% as.data.frame() %>%
      tibble::rownames_to_column("genus")
save(dds_res1_genus_all_alldose_no_appariement, file="dds_res1_genus_all_alldose_no_appariement.rda")
write.csv2(dds_res1_genus_all_alldose_no_appariement, file="dds_res1_genus_all_alldose_no_appariement.csv")
