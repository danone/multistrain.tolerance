...
res_ATN1_v2v3= 
  results(dds2_res2, contrast = list("Groupe_doseATN.1","Groupe_doseATN.1.VisitV3"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
save(res_ATN1_v2v3, file="res_ATN1_v2v3_p0.05.rda")

res_ATN1_v2v4=
results(dds2_res2, contrast = list("Groupe_doseATN.1","Groupe_doseATN.1.VisitV4"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
save(res_ATN1_v2v4, file="res_ATN1_v2v4_p0.05.rda")

res_ATN1_v2v5=
results(dds2_res2, contrast = list("Groupe_doseATN.1","Groupe_doseATN.1.VisitV5"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
...
res_ATN1_CP1_v2=
  results(dds2_res2, contrast = list("Groupe_doseATN.1","Groupe_doseCP.1"), alpha = 0.05) %>% 
  data.frame() %>% tibble::rownames_to_column("genus")  %>% filter(padj<0.05)
