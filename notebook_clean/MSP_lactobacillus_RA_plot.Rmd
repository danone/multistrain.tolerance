...
```{r}
# load taxo MSP
taxoMSP = read.csv2("../data-raw/taxo_1662msp.csv")

# load MSP relative abundance
load("../data-raw/MSP_relative_abundance_matrix_rounded.rda")


  
MSP_relative_abundance_matrix_rounded = prop.table(MSP_relative_abundance_matrix_rounded %>% as.matrix,1)

MSP_relative_abundance_matrix_rounded[which(is.na(MSP_relative_abundance_matrix_rounded))] <-0

MSP_relative_abundance_matrix_rounded= as.data.frame(MSP_relative_abundance_matrix_rounded)

# load metadata
# load("C:/Users/alvareao/Documents/actineo_paper/Rlocal_310719/sample_metadata_metaG.rda")
sample_metadata_metaG = read.csv2("../data-raw/sample_metadata_metaG.csv")
...
save(MSP_RA_Lactobacillus, file="MSP_RA_Lactobacillus.rda")
...
save(sample_metadata_metaG_v2v4_MSP_Lacto, file="sample_metadata_metaG_v2v4_MSP_Lacto.rda")

load("sample_metadata_metaG_v2v4_MSP_Lacto.rda")
...
m.sample_metadata_metaG_v2v4_MSP_Lacto$value[m.sample_metadata_metaG_v2v4_MSP_Lacto$value == 0 ]=1e-06
...
tiff(file="MSP_lactobacillus_AR_plot.tiff", w=1600, h=2000)
cowplot::plot_grid(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,align="h",nrow=5, ncol=4)
dev.off()
